...
router.post('/extract', uploadSinglePdf, normalizePdfFile, extractPdfController.extractPdf);

// POST /api/pdf/rotate — rotationAngle: 90|180|270, pageNumbers optional
router.post('/rotate', uploadSingleFile, normalizePdfFile, rotatePdfController.rotatePdf);
...
router.post('/redact', uploadSinglePdf, normalizePdfFile, redactPdfController.redactPdf);

// POST /api/pdf/pdfa — pdfaLevel (PDF/A-1b, PDF/A-2b, PDF/A-3b)
router.post('/pdfa', uploadSinglePdf, normalizePdfFile, pdfaPdfController.convertToPdfa);
router.post(
  '/unlock',
  uploadSinglePdf,
  normalizePdfFile,
